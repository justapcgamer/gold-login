...
public class SessionGui {
    ...
    private void init() {
        ...
        clientIdLabel = new JLabel("deEsuzdunT (unused):");
        ...
        loginButton.addActionListener((e) -> {
            ...
            switch (accountTypeField.getSelectedItem().toString()) {
                ...
                case "G0LD ALT" -> accountType = Session.AccountType.MSA;
            ...
            ((SessionAccessor) client.getSession()).setUuid(UUID.fromString(uuid));
        ...
        loadCurrentAccountButton = new JButton("(C) G0LD ALTS");
